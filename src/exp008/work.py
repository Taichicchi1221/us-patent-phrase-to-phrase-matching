...
class Dataset(torch.utils.data.Dataset):
    ...
    def preprocess(self, idx: int):
        ...
        anchor = preprocess_text(self.anchors[idx])
        target = preprocess_text(self.targets[idx])
        cpc_text = preprocess_text(self.cpc_texts[self.contexts[idx]])
...
RUN_NAME: exp008
RUN_DESC: "deberta-v3-large accumulation_step=16 lower_case_input"
